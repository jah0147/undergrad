...
public class JacobsWordSearch implements WordSearchGame {
   ...
   */  
   ...
   /**
    * Determines if given word is in on the game board. It returns
    * the path that makes up the word.
    * @param wordToCheck The word to validate
    * @return java.util.List containing java.lang.Integer objects.
    * @throws IllegalArgumentException if wordToCheck is null.
    * @throws IllegalStateException if loadLexicon has not been called.
    */
   ...
   */
   ...
   private class Position {
      ...
      /** Constructs Position with coordinates (x,y). */
      ...
      /** Returns all the neighbors of Position. */
   ...
   /**
    * Checks position has been visited.
    * @param p the position
    */
   ...
   /**
    * Mark valid position as having been visited.
    */
