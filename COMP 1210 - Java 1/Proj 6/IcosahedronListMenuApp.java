...
public class IcosahedronListMenuApp {
   ...
   public static void main(String[] args) throws FileNotFoundException {
      ...
      ArrayList<Icosahedron> i = new ArrayList<Icosahedron>();
      IcosahedronList iList = new IcosahedronList(listName, i);
      ...
      do {
         ...
         switch (userChar) {
            ...
            case 'D':
               ...
               if (iList.deleteIcosahedron(label) != null) {
                  iList.deleteIcosahedron(label);
            ...
            case 'E':
               ...
               if (iList.findIcosahedron(label) != null) {
                  iList.editIcosahedron(label, color, edge);
